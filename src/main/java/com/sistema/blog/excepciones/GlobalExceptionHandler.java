...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorDetalles> manejarResourceNotFoundException(ResouceNotFoundException exception,
	...
	public ResponseEntity<ErrorDetalles> manejarBlogNotFoundException(BlogAppException exception,
			WebRequest webRequest) {
